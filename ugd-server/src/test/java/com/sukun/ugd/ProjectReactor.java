...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.sukun";
    private static final String ARTIFACT_ID = "ugd";
    private static final String PACKAGE_NAME = "com.sukun.ugd";
    private static final String TITLE = "中医问诊系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.sukun";
        String artifactIdNew = "ugd";
        String packageNameNew = "com.sukun.ugd";
        String titleNew = "中医问诊系统";
        String projectBaseDirNew = "D:/Code/Java/ugd"; // 一键改名后，“新”项目所在的目录
