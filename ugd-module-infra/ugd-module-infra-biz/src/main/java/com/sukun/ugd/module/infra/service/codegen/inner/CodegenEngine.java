package com.sukun.ugd.module.infra.service.codegen.inner;
...
import com.sukun.ugd.framework.apilog.core.enums.OperateTypeEnum;
...
import com.sukun.ugd.framework.common.util.date.DateUtils;
import com.sukun.ugd.framework.common.util.date.LocalDateTimeUtils;
import com.sukun.ugd.framework.common.util.object.BeanUtils;
import com.sukun.ugd.framework.common.util.object.ObjectUtils;
import com.sukun.ugd.framework.common.util.string.StrUtils;
import com.sukun.ugd.framework.excel.core.annotations.DictFormat;
import com.sukun.ugd.framework.excel.core.convert.DictConvert;
...
import com.sukun.ugd.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "ugd-module-${table.moduleName}/" + // 顶级模块
                "ugd-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "ugd-module-${table.moduleName}/" + // 顶级模块
                "ugd-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "ugd-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "ugd-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
